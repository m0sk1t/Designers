<article tabindex="1" style="background-position: {{currentSection<3 && (50 * currentSection + '% 0')}}">
	...
	<section style="margin-left: {{'-' + currentSection + '00%'}}">
		...
		<div class="list">
			...
			<div class="content">
				...
				<div class="text">
					...
					<div class="colomn">
						<h2>Другие фильмы</h2>
						<p>Мы творчески разрабатываем<br>действительность, а не просто<br>показываем жизнь, как есть.<br>Работаем в жанре документально-<br>художественного кино, создаем<br>телевизионные проекты, фильмы<br>о путешествиях, семейное кино.</p>
					</div>
				</div>
			</div>
			<div class="footer">
		...
		<div class="list">
			...
			<div class="play">
				<p ng-click="includeVimeo(v.fullvideo); v.display = true;">Смотреть</p>
			</div>
		</div>
		<div class="footer">
				<a ng-href="mailto:{{contact.mail}}">{{contact.mail}}</a><br>
